  ...
  module Message
    class Handler
      ...
      def initialize(message_data:)
        ...
        @parsed_action = message.text[/^\/(.*)\s/, 1]
      end
      ...
      def response_text_on_help
        text = 'I\'m <b>Workflow Bot</b> and related with <a href="https://www.myworkflow.net/">My Workflow Assistant</a>. '
        text += 'You should be the member there for usage.&#10;&#10;'
        text += 'Please control me by <u>notifier(s) settings</u> at your account on <a href="https://www.myworkflow.net/">My Workflow Assistant</a>.'
        text
      end
