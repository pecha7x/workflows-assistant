...
ActiveRecord::Schema[7.0].define(version: 20_230_903_190_140) do
  ...
  create_table 'job_leads', force: :cascade do |t|
    ...
    t.index %w[external_id job_source_id], name: 'index_job_leads_on_external_id_and_job_source_id', unique: true
  ...
  create_table 'notes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[owner_type owner_id], name: 'index_notes_on_owner'
  ...
  create_table 'notifiers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[owner_type owner_id], name: 'index_notifiers_on_owner'
